...
void EgresoAuto(EAuto lisAuto[], EProp lisProp[])
{
    ...
    while (a<T_AUTOS && condicion ==0)
    {
        if ((strcmp(lisAuto[a].patente,dato)==0) && (lisAuto[a].estado==1))
            {
                ...
                {
                    case 1:
                        costoAlpha=devolverHorasEstadia()*150;
                    break;
                    case 2:
                        costoFerrari=devolverHorasEstadia()*175;
                    break;
                    case 3:
                        costoAudi=devolverHorasEstadia()*200;
                    break;
                    case 4:
                        costoOtros=devolverHorasEstadia()*250;
                    break;
                }
            }
        a++;
        ...
        {   a=a-1;
            ...
            int ID_prop=-1;
                          //buscar prop por id
            id_ap = lisAuto[a].idPropietario; printf("idap es : %d",id_ap);system("pause");
    ...
    for(int a=0;a<10;a++)
        {
            ...
            lisAuto[a].idPropietario=propietario;
            lisAuto[a].estado=1;
        }
...
void listarAuto(EAuto lisAuto[])
{
    printf("\n AUTOS EN EL GARAGE:\n\n");
    for(int a=0;a<T_AUTOS;a++)
    {
        if(lisAuto[a].estado==1){printf("Patente: %s ID: %d\n" ,lisAuto[a].patente,lisAuto[a].idPropietario);}
    }
}
    ...
    for(int a=0;a<T_AUTOS;a++)
    {
        if (lisAuto[a].estado==1)
        {
            switch(lisAuto[a].marca)
                {
                    case 1:
                        costoAlpha=costoAlpha+devolverHorasEstadia()*150;
                    break;
                    case 2:
  ...
  for (c = 0 ; c < ( T_AUTOS - 1 ); c++)
  {
    for (d = 0 ; d < T_AUTOS - c - 1; d++)
    {
      ...
      if (strcmp(lisAuto[d].patente,lisAuto[d+1].patente)>0)
      {
        ...
        printf("LISTADO DE AUNTOS ORDENADOS POR PATENTE\n");
        printf("=======================================\n\n");
